...
var TaskTypeRadioGroup_1 = require("./TaskTypeRadioGroup");
...
function Modal() {
    ...
    var imagePickerRef = react_1.useRef(null);
    return (
    // Use the `Transition` component at the root level
    React.createElement(react_2.Transition, { appear: true, show: isOpen, as: react_1.Fragment },
        React.createElement(react_2.Dialog, { onSubmit: handleSubmit, as: 'form', className: 'relative z-10', onClose: closeModal },
                        ...
                        React.createElement(react_2.Dialog.Panel, { className: "w-full max-w-md transform overflow-hidden \r\n                            rounded-2xl bg-white p-6 text-left align-middle \r\n                            shadow-xl transition-all" },
                            ...
                            React.createElement("div", null,
                                React.createElement("button", { type: 'button', onClick: function () {
                                    ...
                                    React.createElement(solid_1.PhotoIcon, { className: 'w-6 h-6 mr-2 inline-block' })),
                                image && (React.createElement(image_1["default"], { alt: "Uploaded Image", width: 200, height: 200, className: 'w-full h-44 object-cover mt-2 filter hover:grayscale \r\n                                                transition-all duration-150 cursor-not-allowed', src: URL.createObjectURL(image), onClick: function () {
                                        setImage(null);
                                    } })),
                            ...
                            React.createElement("div", { className: "mt-2 justify-center align-middle content-center flex" },
                                React.createElement("button", { type: "submit", className: "bg-blue-100 text-blue-900 p-2 rounded-md focus-visible:ring-2 focus-visible:ring-blue-900 focus:outline-none w-full focus-visible:ring-offset-2 disabled:text-gray-300 disabled:bg-gray-100", disabled: !newTaskInput }, "Add Task")))))))));
}
